...
CREATE TABLE IF NOT EXISTS `bills` (
  ...
  `billNumber` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `containers` (
  ...
  `quantity_of_bags` int DEFAULT NULL,
  `w_jute_bag` decimal(4,2) DEFAULT '1.00',
  `w_total` int DEFAULT NULL,
  `w_truck` int DEFAULT NULL,
  `w_container` int DEFAULT NULL,
  `w_gross` int DEFAULT NULL,
  `w_dunnage_dribag` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cutting_tests` (
  ...
  `w_reject_nut` smallint unsigned DEFAULT NULL COMMENT 'Trọng lượng hạt lỗi hoàn toàn',
