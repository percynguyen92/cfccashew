...
<body class="bg-base-300 font-sans antialiased">
    <div x-data="billsApp()" x-init="init()" class="min-h-screen flex flex-col bg-gradient-to-r from-cyan-500 to-blue-500">
        <!-- Main -->
        <main class="max-w-6xl mx-auto">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-16">
                        <div class="flex items-center space-x-4">
                            <button x-show="view !== 'list'" @click="changeView('list')" class="btn btn-ghost btn-circle">
            ...
            <template x-if="globalError">
                <div class="alert alert-error shadow-lg mb-6">
                    ...
                    <button @click="globalError=''" class="btn btn-sm btn-circle btn-ghost">✕</button>
                </div>
            </template> 
                ...
                <div class="shadow-lg card bg-base-200 p-6 mb-6">
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <input
                            ...
                            x-model.debounce.500ms="queryParams.search"
                            ...
                            <template x-if="!loading && bills.length === 0">
                                <tr>
                                    <td colspan="4" class="text-center py-12 text-gray-500">
                                        ...
                                        <p>Không tìm thấy Bill nào trong cơ sở dữ liệu.</p>
                                        <p>Tạo một bill mới để bắt đầu công việc.</p>
                                    </td>
                                </tr>
                            </template>
                            <template x-for="bill in bills" :key="bill.id">
                                <tr class="hover:bg-base-300 transition-colors">
                                    ...
                                    <td class="text-right space-x-2">
                                        ...
                                        <button @click="changeView('edit', bill.id)" class="btn btn-ghost btn-sm btn-success">
            ...
            <!-- Pagination -->
            <nav class="bg-base-200 shadow-lg rounded-lg mt-4 p-4 flex justify-center items-center" x-show="pagination.last_page > 1">
                    <button
                        @click="gotoPage(Math.max(1, queryParams.page - 1))"
                ...
                <button
                        @click="gotoPage(Math.min(pagination.last_page, queryParams.page + 1))"
                        :disabled="queryParams.page >= pagination.last_page"
                        class="btn btn-square btn-sm mx-1"
                    >
                ...
                <section x-transition>
                    <div class="card bg-base-200 p-8 max-w-2xl mx-auto">
                        ...
                        <div class="flex justify-between">
                            <button @click="changeView('list')" class="btn btn-outline">Trở lại danh sách</button>
                            <button @click="changeView('edit', currentBill.id)" class="btn btn-primary">Sửa</button>
                        </div>
                    </div>
                </section>
            </template>
            ...
            >
                ...
                >
                    ...
                    <p class="mb-6">
                        Bạn có chắc muốn xoá bill <strong x-text="billToDelete?.billNumber"></strong>?
                    </p>
