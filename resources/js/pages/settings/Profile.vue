            ...
            <div class="flex flex-col space-y-6">
                ...
                >
                    <div class="grid gap-2">
                        <Label for="name">{{ $t('settings.profile.fields.name.label') }}</Label>
                        <Input
                            id="name"
                    ...
                    <div class="grid gap-2">
                        <Label for="email">{{ $t('settings.profile.fields.email.label') }}</Label>
                        <Input
                            id="email"
                            type="email"
                            class="mt-1 block w-full"
                    ...
                    <div v-if="mustVerifyEmail && !user.email_verified_at">
                        <p class="-mt-4 text-sm text-muted-foreground">
                            ...
                            >
                                {{ $t('settings.profile.verification.resend') }}
                            </Link>
                        </p>
                        ...
                        >
                            {{ $t('settings.profile.verification.sent') }}
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        >
                            ...
                            >
                                {{ $t('settings.profile.status.saved') }}
                            </p>
                        </Transition>
                    </div>
                </Form>
