...
// Form setup
const form = useForm({
    bill_id: props.bill_id || props.bill?.id || '',
    truck: '',
    container_number: '',
    quantity_of_bags: null as number | null,
    w_jute_bag: 1.00,
    w_total: null as number | null,
    w_truck: null as number | null,
    w_container: null as number | null,
    w_gross: null as number | null,
    w_dunnage_dribag: null as number | null,
    w_tare: null as number | null,
    w_net: null as number | null,
    note: '',
});
...
const goBack = () => {
    if (props.bill) {
        router.visit(billRoutes.show.url(props.bill.slug || props.bill.id));
    } else {
                        ...
                        <Card>
                            ...
                            <CardContent class="space-y-3">
                                <Button type="submit" class="w-full" :disabled="form.processing">
                                    ...
                                    {{ form.processing ? 'Creating...' : 'Create Container' }}
                                </Button>
