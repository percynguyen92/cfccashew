...
import WeightCalculationDisplay from './WeightCalculationDisplay.vue';
...
// Initialize weight calculations composable
const {
    calculatedWeights,
    calculationStatus,
    discrepancies,
...
// Watch form changes and update weight calculations
watch(
    () => ({
...
const calculationIssues = computed(() => ({
    isValid: calculationIsValid.value,
    issues: discrepancies.value.map(d => d.message),
}));
...
const handleSubmit = () => {
    ...
    form.transform((data) => ({
        ...
        w_gross: calculatedWeights.value.w_gross,
        w_tare: calculatedWeights.value.w_tare,
        w_net: calculatedWeights.value.w_net,
    ...
    <Card>
        ...
        <CardContent>
            <form @submit.prevent="handleSubmit" class="space-y-6">
                <InputError v-if="form.errors.bill_id" :message="form.errors.bill_id" class="text-red-600" />
                <!-- Container Details -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <Input id="truck" v-model="form.truck" type="text" :placeholder="t('containers.form.fields.truck.placeholder')
                            " :aria-invalid="Boolean(form.errors.truck)"
                            :class="{ 'border-red-500': form.errors.truck }" @input="clearError('truck')" />
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="container_number" v-model="form.container_number" type="text" :placeholder="t('containers.form.fields.containerNumber.placeholder')
                            " maxlength="11" :aria-invalid="Boolean(form.errors.container_number)"
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <Input id="quantity_of_bags" v-model.number="form.quantity_of_bags" type="number" min="0"
                                :placeholder="t(
                        ...
                        <div class="space-y-2">
                            <Label for="w_jute_bag">
                                ...
                                <span v-if="bill && !isEditing" class="text-xs text-muted-foreground ml-1">(from
                                    bill)</span>
                            </Label>
                            <Input id="w_jute_bag" v-model.number="form.w_jute_bag" type="number" step="0.01" min="0"
                                max="99.99" :placeholder="t('containers.form.fields.juteBagWeight.placeholder')
                                    " :readonly="!!bill && !isEditing" :disabled="!!bill && !isEditing"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="space-y-2">
                            ...
                            <Input id="w_total" v-model.number="form.w_total" type="number" min="1" :placeholder="t('containers.form.fields.totalWeight.placeholder')
                                " :aria-invalid="Boolean(form.errors.w_total)"
                                :class="{ 'border-red-500': form.errors.w_total }" @input="clearError('w_total')" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="w_truck" v-model.number="form.w_truck" type="number" min="1" :placeholder="t('containers.form.fields.truckWeight.placeholder')
                                " :aria-invalid="Boolean(form.errors.w_truck)"
                                :class="{ 'border-red-500': form.errors.w_truck }" @input="clearError('w_truck')" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="w_container" v-model.number="form.w_container" type="number" min="1"
                                :placeholder="t('containers.form.fields.containerWeight.placeholder')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="space-y-2">
                            ...
                            <Input id="w_dunnage_dribag" v-model.number="form.w_dunnage_dribag" type="number" min="0"
                                :placeholder="t('containers.form.fields.dunnageWeight.placeholder')
                                    " :readonly="!!bill && !isEditing" :disabled="!!bill && !isEditing"
                ...
                <WeightCalculationDisplay :calculated-weights="calculatedWeights"
                    :calculation-status="calculationStatus" :discrepancies="discrepancies"
                    :is-valid="calculationIsValid" :has-discrepancies="hasDiscrepancies" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <Input id="container_condition" v-model="form.container_condition" type="text" maxlength="255"
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="seal_condition" v-model="form.seal_condition" type="text" maxlength="255"
                ...
                <div class="space-y-2">
                    ...
                    <Textarea id="note" v-model="form.note" :placeholder="t('containers.form.fields.note.placeholder')
                        " rows="3" :aria-invalid="Boolean(form.errors.note)"
                        :class="{ 'border-red-500': form.errors.note }" @input="clearError('note')" />
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t">
                    ...
                    <Button type="submit" :disabled="form.processing || !calculationIssues.isValid"
                        class="min-w-[120px]">
